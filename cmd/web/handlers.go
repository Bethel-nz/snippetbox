...
func (app *application) postSnippetCreate(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.PermittedValue(form.Expires, 1, 3, 7, 365), "expires", "This field must be equal to 1, 3, 7, or 365")
...
func (app *application) postUserSignup(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, models.ErrDuplicateEmail) {
			...
			data := app.newTemplateData(r)
			data.Form = form
			app.render(w, r, http.StatusUnprocessableEntity, "signup.toml", data)
		} else {
			app.serverError(w, r, err)
		}
		return
...
func (app *application) userLogin(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintln(w, "Display a form for loggin in a new user....")
}
